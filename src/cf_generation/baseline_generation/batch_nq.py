"""
context_text <hl>answer<hl> context_text
...
def get_strided_contexts_and_ans(
    ...
    if example["answer"]["category"] in [3, 4]:
        input = f"generate question: {context} {hl_token} {answer_text[0]} {hl_token}"
    else:
    ...
    if answer["category"] in [3, 4]:  # category is an integer
        ...
        for i in doc_start_indices:
            end_index = i + max_length - cmd_len
...
if __name__ == "__main__":
    ...
    c = 0
    data = []
    cache_file_name = "data/nq-train-tokenized-short-qg"
