...
def get_arg_parser():
    ...
    pretrained_group.add_argument("--embedder_path", type=str,
                                  default=r"./data/cc_news_pretrained/embedder/variables/variables",
                                  help="Pretrained embedder path.")
    pretrained_group.add_argument("--bert_path", type=str,
    ...
    finetuned_group.add_argument("--checkpoint_path", type=str,
