...
def main():
    ...
    # if not data_args.val_max_target_length:
    ...
    def prepare_train_features(examples):
        ...
        tokenized_examples = tokenizer(
            ...
            return_overflowing_tokens=True,  # in long contexts
    ...
    def post_processing_function(examples, features, predictions, stage="eval"):
        ...
        predictions = postprocess_qa_predictions(
            ...
            output_dir=sagemaker_args.output_data_dir,
    ...
    output_results_file = os.path.join(sagemaker_args.output_data_dir, "results.txt")
