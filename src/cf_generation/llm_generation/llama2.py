...
model = AutoModelForCausalLM.from_pretrained(f"meta-llama/{model_name}")#, torch_dtype=torch.bfloat16)
model.to(device)
...
if __name__ == '__main__':
    ...
    save_path = BASE_PATH + f"src/data/squad/{model_name}_qa_relevance_{test_model}_seed_{args.seed}/"
