...
class LLMClient:
    ...
    def _load_model(self):
        model = get_llama(self.model).to(self.device)
        tokenizer = LlamaTokenizer.from_pretrained(self.model)
...
""".strip()
    ...
    cf_qa_template = """
Given the context and question, generate a question that negates the question.
""".strip()
