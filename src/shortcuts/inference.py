...
if __name__ == "__main__":
    ...
    path = f"{BASE_PATH}src/data/{args.dataset}"
    save_file_name = args.model_name.split("/")[0]
    output_nbest_file = os.path.join(path, f"nbest_predictions_{save_file_name}.json")
